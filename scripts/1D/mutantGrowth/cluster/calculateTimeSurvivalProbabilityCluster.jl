...
savefig(p, expanduser("~/coevolution/figures/mutantGrowth/survivalProbability/survProb_r$(r)R0$(R0)D$(D)tmax$(tmax).png"))
...
baseFolder = expanduser("~/coevolution/simulations/mutantGrowth/")
...
baseFolder = expanduser("~/coevolution/simulations/mutantGrowth/timeSurvivalProb")
