include("~/coevolution/code/mutantGrowth/secondMutantStudy.jl")
...
savefig(p, "~/coevolution/figures/mutantGrowth/survivalProbability/survProb_r$(r)R0$(R0)D$(D)tmax$(tmax).png")
...
baseFolder = "~/coevolution/simulations/mutantGrowth/"
...
baseFolder = "~/coevolution/simulations/mutantGrowth/timeSurvivalProb"
